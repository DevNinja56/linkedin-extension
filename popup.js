      ...
      xhr1.onreadystatechange = function () {
        ...
        if (xhr1.readyState == 4 && xhr1.status == 200) {
          if (xhr1.responseText != "400") {
            ...
            document.getElementById("pills-tab-2").innerText = `Access Your Friend's Databases (${respon.length})`
            // var row =
            ...
            if(respon.length > 0){
              localStorage.setItem("friends",JSON.stringify(respon))
            }
    ...
    xhr.onreadystatechange = function () {
      ...
      if (xhr.readyState == 4 && xhr.status == 200) {
        if (xhr.responseText != "400") {
          ...
          var myToast = Toastify({
            text: "Confirmation Email Sent Successful",
            duration: 2000,
          });
  ...
  xhr.onreadystatechange = function () {
    ...
    if (xhr.readyState == 4 && xhr.status == 200) {
      ...
      if (res != "400") {
        ...
        document.getElementById("client_messages").value = res.user.notes;
