...
setTimeout(() => {
  ...
  r.src = "./Assets/img/selected_group.svg"
...
function sendMessage(e) {
  ...
  let msgInp = document.getElementById("second_message_div").value;
  if (msgInp.includes("http") && !msgInp.includes("cloudinary")) {
...
function notification_component(){
  ...
  document.querySelector(".groupBoxContainer").innerHTML = `<div style="display:block;margin-left:0px" class="notificationss_div"><div class="redirectors" style="display:flex"><select class="shring_in" id="shring_in" style="padding: 5px 10px; border-radius: 5px; border: 2px solid rgb(223, 233, 250); cursor: pointer; display: block;">
  
  
  <option style="cursor: pointer;" value="1" selected>
    Direct Messages
  </option>
...
function group_notifications(){
  ...
  const url = `${globalURl}/recieve_messages_group/${user_id}`;
    ...
    if (xhr.readyState == 4 && xhr.status == 200) {
      ...
      if(userData.data){
        ...
        userData.data.map((item) => {
          ...
          variable_date = item.created_at.toString()
          tempo = variable_date.split(" ")
          the_time = tempo[1]
          ...
          "> ${top_message} ${item.seen_status ? ``: `${item.new == 'yes'? `<span style="font-weight:700;color:#AAFF00;padding:4px">New</span>` : ``}`}
              ...
              <span class="time-rightt"style=" background-color:#dfe9fa ;padding:3px">${the_time}</span>
...
function direct_notifications (){
  ...
  const url = `${globalURl}/recieve_messages/${user_id}`;
  ...
  document.getElementById("addFileInput").addEventListener("change", () => {
    ...
    fetch("https://api.cloudinary.com/v1_1/fastech/image/upload", {
      ...
      .then(data => {
        ...
        savedImage = data.url;
        if(savedImage){
          document.getElementById("send_message_div").value = `<a href="${savedImage}" target="blank">${savedImage}</a>`;
  ...
  document.getElementById("screenaddFileInput").addEventListener("change", () => {
    ...
    fetch("https://api.cloudinary.com/v1_1/fastech/image/upload", {
      ...
      .then(data => {
        ...
        document.getElementById("second_message_div").value = `<a href="${savedImage}" target="blank">${savedImage}</a>`;
  ...
  const url = `${globalURl}/open_threads/${message_id}/${chat}`;
                ...
                xhr.onreadystatechange = function () {
                  if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    if(userData.thread){
                      document.getElementById("adding_threads").innerHTML = `
                      <div class="card my-2 rounded"  style="position: relative;margin-bottom: 10px;">
          <div class="card-body p-2 px-2 d-flex justify-content-between align-items-center" style="background-color: 	#89CFF0;">
              ...
              <div class="row " style="width:365px;margin-left:0px ;">
                ...
                <div class="card-left-content-box" style="width: 315px;">
                  ...
                  <div class="btn-hover">
                        ...
                        <button data-replied_id="${item.id}" class="share-hover-btn edit_thread_message" title="Edit message"><i class="fas fa-edit"></i></button>
                  ...
                  <div class="msg-box-chat"><span  style="color:#282828;"> ${item.text}</div>
...
if (document.getElementById("send_thread_button")) {
  document.getElementById("send_thread_button").addEventListener("click", () => {
